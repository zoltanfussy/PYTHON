...
os.chdir("/Users/zoliq/ownCloud/Jankoviny/Tick_transcriptome/TREE2")
...
command = "{0} -d protein -i safe-{1}.fasta -j {1} -o TREE1".format(args.aligner, filename)
print("issuing aligner\n" + command)
os.system(command)

#copy and rename PASTA alignment to current directory and issue trimal
os.system("cp ./TREE1/{0}.marker001.safe-{0}.aln ./safe-{0}.aln".format(filename))
