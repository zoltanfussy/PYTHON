...
print('ERASE OLD pred-ML2-cleave.txt WHEN STARTING WITH A NEW DATASET.\n=================================================\n')
...
os.system('rm input_cleaved.txt')
...
print("cleaved proteins written to input_cleaved.txt... now running MultiLoc2 plant")
if os.path.isfile("pred-ML2-cleave.txt") == False:
	os.system('python /home/manager/MultiLoc2/src/multiloc2_prediction.py -fasta=input_cleaved.txt -predictor=LowRes -origin=plant -result=pred-ML2-cleave.txt -output=simple')
