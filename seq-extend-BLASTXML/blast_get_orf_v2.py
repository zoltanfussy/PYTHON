#!/usr/bin/python3
#!!! Check parsing record.query in the blast_parser function (5x) ('Monsieur Guillotin') !!!
...
dbfasta = SeqIO.parse(owncloudpath + '/large/seq-extend-BLASTXML/Chromera_velia_MMETSP0290-trans_NCBI-Woehle.fasta', 'fasta')
queryfasta = SeqIO.parse(owncloudpath + '/large/seq-extend-BLASTXML/chromera_all.fasta', 'fasta')
nt_out = open(owncloudpath + '/large/seq-extend-BLASTXML/chromera_all-elong_nt_mmetsp-ncbi.txt', 'w')
aa_out = open(owncloudpath + '/large/seq-extend-BLASTXML/chromera_all-elong_aa_mmetsp-ncbi.txt', 'w')
err_out = open(owncloudpath + '/large/seq-extend-BLASTXML/chromera_all_errors_mmetsp-ncbi.txt', 'w')
logfile = open(owncloudpath + '/large/seq-extend-BLASTXML/chromera_all_logfile_mmetsp-ncbi.txt', 'w')
