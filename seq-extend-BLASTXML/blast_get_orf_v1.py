...
nt_out = open('/Users/zoliq/ownCloud/large/seq-extend-BLASTXML/vitrella_refs-elong_nt.txt', 'w')
aa_out = open('/Users/zoliq/ownCloud/large/seq-extend-BLASTXML/vitrella_refs-elong_aa.txt', 'w')
err_out = open('/Users/zoliq/ownCloud/large/seq-extend-BLASTXML/vitrella_refs_errors.txt', 'w')
result_handle = open('/Users/zoliq/ownCloud/large/seq-extend-BLASTXML/vbra_refs_blast.xml')
		...
		try:
			...
			if best.hsps[0].expect > 0.01:
				...
				for hsp in best.hsps:
					#here i want to check how many mismatches are there in the HSP alignment!
					#NOT YET TESTED!!
...
for contig in fasta:
	for key, value in blast_dict.items():
		if contig.name == value[3]: #searches the blast dictionary until finds the correct query/hit pair
			frame = value[2]
			ref_name = key
			if frame in [1, 2, 3]:
