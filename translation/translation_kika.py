...
infile = SeqIO.parse('/Volumes/zoliq data/OwnCloud/genomes/euglena longa/ZORFome2/analyze.fasta', 'fasta')
output = open('/Volumes/zoliq data/OwnCloud/genomes/euglena longa/ZORFome2/analyze_out.fasta', 'w')
